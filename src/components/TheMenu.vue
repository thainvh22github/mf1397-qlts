<template>
  <div class="m-menu">
    <div class="m-sidebar" :style="{ width: sidebarWidth }">
      ...
      <div
        class="m-option"
        @mouseover="overViewMouseOver"
        @mouseleave="overViewMouseLeave"
      >
        <span v-if="collapsed">
          <div
            class="tooltip-arrow ml-13"
            :class="{
              miconoverview: miconoverview,
              miconoverviewactive: miconoverviewactive,
            }"
          >
      ...
      <div
        class="m-option"
        @mouseover="ProretyhtdbMouseOver"
        @mouseleave="ProretyhtdbMouseLeave"
      >
        <span v-if="collapsed">
          <div
            class="tooltip-arrow ml-13"
            :class="{
              miconproretyhtdb: miconproretyhtdb,
              miconproretyhtdbactive: miconproretyhtdbactive,
            }"
          >
      ...
      >
        <span v-if="collapsed">
          <div
            class="tooltip-arrow ml-13"
            :class="{ micontool: micontool, micontoolactive: micontoolactive }"
          >
      ...
      >
        <span v-if="collapsed">
          <div
            class="tooltip-arrow ml-13"
            :class="{
              miconcategory: miconcategory,
              miconcategoryactive: miconcategoryactive,
            }"
          >
